...
// handles the route for the articles view that uses client-side js
Route::add('/articles-js', function () {
    require_once(__DIR__ . "/../views/pages/articles_js.php"); // load the view
});
